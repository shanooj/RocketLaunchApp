package com.karbaros.rocketlaunch;
...
public class RocketAdapter extends RecyclerView.Adapter<RocketAdapter.RocketViewHolder> {
  ...
  private final List<com.karbaros.rocketlaunch.RocketAnimationItem> mItems;
  private final Context mContext;

  public RocketAdapter(Context context, List<com.karbaros.rocketlaunch.RocketAnimationItem> items) {
    super();
    mContext = context;
    mItems = items;
  }
